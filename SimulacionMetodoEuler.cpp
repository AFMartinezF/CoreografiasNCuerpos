...
double distancia (double r_cuerpo1[][2], double r_cuerpo2[][2],int dim,int iteracion); //Función que calcula la distancia euclidiana entre dos puntos
double dv_euler(double  G, double m, double r_cuerpo1[][2], double r_cuerpo2[][2],int dim,int iteracion); //Diferencial de velocidad
double dy_euler(double v); //Diferencial de posición
void escribir(int i, double r1[][2], double r2[][2], double r3[][2]); //Función que escribe los resultados en un archivo
...
int main() {
  ...
  double eul12; double eul13; double eul21; double eul23; double eul31; double eul32; //variables para almacenar los valores retornados por la función de euler para v
  cout<<"re: "<<r3[0][0]<<endl;
  cout<<"re: "<<r3[0][1]<<endl;
  for(int t = t_0; t < t_final; t = t + dt){
    ...
    //Calculo de las distancias relativas entre cuerpos
    ...
    //Calculo del valor del metodo de euler para v
    ...
    //Actualización de las velocidades para cada cuerpo con sus respectivos valores en cada grado de libertad
    ...
    //Actualización de las posiciones para cada cuerpo con sus respectivos valores en cada grado de libertad
...
double distancia (double r_cuerpo1[][2], double r_cuerpo2[][2],int dim, int iteracion){
  ...
  for (int i = iteracion; i< iteracion+dim; i++){
    //cout<<i<<endl;
    diferencias [i-iteracion] = r_cuerpo1[iteracion][i-iteracion]-r_cuerpo2[iteracion][i-iteracion];
    cout<<"r2 "<<r_cuerpo2[i][i-iteracion]<<endl;
    cout<<"o: "<<i-iteracion<<endl;
    cout<<"i:"<<iteracion<<endl;
    cout<<"dif "<<diferencias[i-iteracion]<<endl;
  }
