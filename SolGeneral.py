import numpy as np
# funciones EDO segundo orden en posicion de cada masa
...
RFinal = LF(100,6,R,V)
np.savetxt("SolGeneral.csv ",RFinal ,delimiter=",") #guarda los resultados en un archivo .csv
